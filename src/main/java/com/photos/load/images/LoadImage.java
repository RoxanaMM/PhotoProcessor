...
public class LoadImage extends Algorithms {
    ...
    public static void readPixels(File folder) {
        ...
        for (File firstFileEntry : listOfFiles) {
            for (File fileEntry : listOfFiles) {
                if (fileEntry.getAbsolutePath().contains("tif")) {
            ...
            System.out.println("another first image");
        }
    }
    ...
    public static void main(String[] args) throws Exception {
        String filePath = "E:\\MASTER\\an2\\disertatie\\temaDisertatie\\Colored Brodatz";
